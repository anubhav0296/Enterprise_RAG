"""Application settings loaded from environment variables for GCP, Qdrant, embeddings, and tracing."""
...
class Settings:
    # --- GCP Core ---
    PROJECT_ID = os.getenv("PROJECT_ID", "enterprise-rag-498513")
    LOCATION = os.getenv("LOCATION", "us-central1")
    GCP_DOC_AI_LOCATION = os.getenv("GCP_DOC_AI_LOCATION", "us")
    GCP_DOC_AI_PROCESSOR_ID = os.getenv("GCP_DOC_AI_PROCESSOR_ID")
    RAW_BUCKET = os.getenv("GCP_RAW_BUCKET", "enterprise-rag-498513-raw")
    PROCESSED_BUCKET = os.getenv("GCP_PROCESSED_BUCKET", "enterprise-rag-498513-processed")
